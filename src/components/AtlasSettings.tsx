...
export function AtlasSettings(props: AtlasSettingsProps) {
  return <section className="settings-popover glass">
    ...
    <label className="small-control">Opacidade das nuvens · {Math.round(props.cloudOpacity * 100)}%<input type="range" min="0" max="0.7" step="0.05" value={props.cloudOpacity} onChange={(event) => props.onCloudOpacityChange(Number(event.target.value))} /></label>
